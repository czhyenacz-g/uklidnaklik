      ...
      <ul className="space-y-3">
        {items.map((item) => (
          <li key={item} className="flex items-start gap-3">
            <span className="mt-1 shrink-0 w-5 h-5 rounded-full border-2 border-black text-black flex items-center justify-center">
...
export default function Services({ services }: { services: string[] }) {
  return (
    <section id="services" className="py-16 px-4 bg-[#3EC1D3]">
      <div className="max-w-3xl mx-auto">
        <h2 className="text-3xl font-black text-center mb-12 text-black">
          Co pro vás{" "}
